                    ...
                    <form class="form-horizontal col-lg-6" method="post" onsubmit="return false;" id="data_form">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="form-control" disabled value="${user.id}" type="text" placeholder="请输入学号" >
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">姓名</label>
                            <div class="col-sm-8">
                                <input class="form-control"  value="${user.name}" type="text" name="name"  id="name" placeholder="请输入姓名" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input class="form-control" value="${user.className}" type="text" name="className" id="className">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control" name="roleId" id="roleId">
                                    ...
                                    <option value="1" ${user.roleId==1?"selected":""}>学生</option>
                                    <option value="2" ${user.roleId==2?"selected":""}>社团管理员</option>
                                    <option value="3" ${user.roleId==3?"selected":""}>系统管理员</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
