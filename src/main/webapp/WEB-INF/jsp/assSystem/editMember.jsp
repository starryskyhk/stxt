    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form enctype="multipart/form-data" class="form-horizontal col-lg-6" method="post" onsubmit="return false;" id="data_form">
                        <input hidden name="id" value="${member.id}">
                        <div class="form-group">
                            <label class="col-sm-3 control-label">职位</label>
                            <div class="col-sm-8">
                                <input class="form-control" value="${member.rank}" type="text" placeholder="请输入职位" name="rank"
                                       id="rank">
                            </div>
                        </div>
                        <div class="form-group">
