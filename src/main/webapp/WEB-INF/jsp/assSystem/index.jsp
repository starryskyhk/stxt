    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li>
                    <a class="J_menuItem" href="/assBack/editInfo"><i class="fa fa-archive"></i> <span
        ...
        <div class="row border-bottom">
            <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                ...
                <ul class="nav navbar-top-links navbar-right">
                    <li class="dropdown">
                        <b>
                            <p style="font-size: 18px;color:black;font-family: '黑体';padding-top: 13px">社团管理员:${sessionScope.user.name},您好<a style="font-size: 18px;color:blue;font-family: '黑体';padding-top: 13px" href="/exit">退出</a></p>
