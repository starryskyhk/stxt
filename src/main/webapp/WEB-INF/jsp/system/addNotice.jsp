                ...
                <div class="card-body">
                    <form enctype="multipart/form-data" class="form-horizontal col-lg-6" method="put" onsubmit="return false;" id="data_form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input class="form-control" type="text" placeholder="请输入公告标题" name="title"
                                       id="title">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <textarea cols="65%" rows="10%" placeholder="请输入公告内容" name="content" id="content"></textarea>
                            </div>
                        </div>
                        <input hidden name="userId" value="${sessionScope.user.id}">
                        <input hidden name="associationId" value="${sessionScope.associationId}">
                        <div class="form-group">
